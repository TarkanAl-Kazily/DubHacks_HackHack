 ...
 */
public class ReminderSpeechlet implements Speechlet {
    private static final Logger log = LoggerFactory.getLogger(ReminderSpeechlet.class);
    ...
    public SpeechletResponse onLaunch(final LaunchRequest request, final Session session)
        ...
        return reminderManager.getLaunchResponse(request, session);
    }
    ...
    public SpeechletResponse onIntent(IntentRequest request, Session session)
        ...
        if ("DidITakePresIntent".equals(intent.getName())) {
            ...
            return reminderManager.getExitIntentResponse(intent, session, skillContext);
    ...
    private void initializeComponents() {
        if (amazonDynamoDBClient == null) {
            ...
            reminderManager = new ReminderManager(amazonDynamoDBClient);
